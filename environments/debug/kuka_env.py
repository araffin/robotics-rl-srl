...
kukaId = p.loadURDF(os.path.join(urdf_root_path, "kuka_iiwa/model.urdf"), [0, 0, 0], useFixedBase=True)
...
print(urdf_root_path)

p.loadURDF(os.path.join(urdf_root_path, "cube.urdf"), [2, 2, 5])
p.loadURDF(os.path.join(urdf_root_path, "cube.urdf"), [-2, -2, 5])
p.loadURDF(os.path.join(urdf_root_path, "cube.urdf"), [2, -2, 5])
