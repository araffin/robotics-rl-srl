...
class Kuka:
    ...
    def reset(self):
        ...
        p.resetBasePositionAndOrientation(self.kukaUid, [-0.100000, 0.000000, -0.15],
    ...
    def applyAction(self, motorCommands):
        ...
        if self.useInverseKinematics:
            ...
            dz = motorCommands[2]
            da = motorCommands[3]
            fingerAngle = 0  # Close the gripper
            ...
            # fingers
            p.setJointMotorControl2(self.kukaUid, 7, p.POSITION_CONTROL, targetPosition=self.endEffectorAngle,
                                    force=self.maxForce)
